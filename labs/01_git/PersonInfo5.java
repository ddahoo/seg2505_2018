public class PersonInfo5 {
    ...
    public static String firstName = "Jean-Luc";
    public static String lastName = "Blais-Amyot";
    public static int studentNo = 300035269;
    public static String description = "CompSci. hello";
