public class PersonInfo1 {
    ...
    public static String firstName = "Lydia";
    public static String lastName = "Leduc";
    public static int studentNo = 8990797;
    public static String description = "Loves to dance";
